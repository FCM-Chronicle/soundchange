...
const QUIZ_DATA = [
  ...
  { "word": "낱낱이", "steps": [{ "result": "낟나티", "rule": "끝소리변화" }, { "result": "난나티", "rule": "비음화" }, { "result": "난나치", "rule": "구" }] },
  ...
  { "word": "낱낱이도", "steps": [{ "result": "낟나티도", "rule": "끝소리변화" }, { "result": "난나티도", "rule": "비음화" }, { "result": "난나치도", "rule": "구" }] },
  { "word": "끝낱이", "steps": [{ "result": "끋나티", "rule": "끝소리변화" }, { "result": "끈나티", "rule": "비음화" }, { "result": "끈나치", "rule": "구" }] },
  ...
  { "word": "곪히다", "steps": [{ "result": "골미다", "rule": "ㅎ탈락" }] },
  ...
  { "word": "굳히다", "steps": [{ "result": "구티다", "rule": "거센소리되기" }, { "result": "구치다", "rule": "구" }] },
  { "word": "닫히다", "steps": [{ "result": "다티다", "rule": "거센소리되기" }, { "result": "다치다", "rule": "구" }] },
  { "word": "묻히다", "steps": [{ "result": "무티다", "rule": "거센소리되기" }, { "result": "무치다", "rule": "구" }] },
